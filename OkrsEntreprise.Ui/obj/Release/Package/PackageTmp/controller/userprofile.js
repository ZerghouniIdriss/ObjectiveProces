okrsapp.controller('userprofile', ['$scope', '$rootScope', '$location', '$routeParams', 'localdata', 'userservice',
    function ($scope, $rootScope, $location, $routeParams, localdata, userservice) {

        $scope.editformData = {};
        $scope.editformData.Roles = [];
        $scope.editformData.Manager = {};
        $scope.userList = [];
        $scope.assignees = [];
        ...
        $scope.updateUserManager = function () {
            var Manager = JSON.parse($("#userManagerSelect").val());
            if ($("#userManagerSelect").val() == null)
