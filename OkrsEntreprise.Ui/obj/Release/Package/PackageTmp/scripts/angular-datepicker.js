...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , datepickerDirective720 = function datepickerDirective720($window, $compile, $locale, $filter, $interpolate) {
  ...
  angular.module('720kb.datepicker', [])
               .directive('datepicker720', ['$window', '$compile', '$locale', '$filter', '$interpolate', datepickerDirective720]);
}(angular, navigator));
