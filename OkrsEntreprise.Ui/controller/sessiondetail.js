okrsapp.controller('sessiondetail', ['$scope', '$location', '$routeParams', 'localdata', 'dataservice', function ($scope, $location, $routeParams, localdata, dataservice) {
    ...
    $scope.getsession = function (id) {
        ...
        var promise = dataservice.getsession(id);
        promise
